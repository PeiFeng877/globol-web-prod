 ...
 * 职责: 多语言首页与 SEO 元数据。
 */
import { MainCarousel, type Slide } from "@/components/sections/MainCarousel";
...
export default async function Home({ params }: PageProps) {
  ...
  // Build slides with server-side translations
  const slides: Slide[] = [
    { id: 1, title: t.carousel.slide1, image: '/assets/slide-1.webp', bgGradient: 'from-pink-100 to-blue-50' },
    { id: 2, title: t.carousel.slide2, image: '/assets/slide-2.webp', bgGradient: 'from-blue-50 to-indigo-50' },
    { id: 3, title: t.carousel.slide3, image: '/assets/slide-3.webp', bgGradient: 'from-indigo-50 to-purple-50' },
